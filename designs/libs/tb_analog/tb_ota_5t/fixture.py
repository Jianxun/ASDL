...
def netlist_stimulus_sin(vin_dc=1.5, freq=1e6, amp=100e-3, t_delay=0, theta=0, phase=0):
    ...
    * ---------------- Stimulus ----------------
    ...
    """
def netlist_stimulus_square(v_low=0, v_high=100e-3, t_rise=0, t_fall=0, t_delay=0, period=100e-9):
    """Generate square wave stimulus
    Args:
        vin_dc: DC offset voltage
    ...
    * ---------------- Square Wave Stimulus ----------------
    V_src in vssa PULSE({v_low} {v_high} {t_delay} {t_rise} {t_fall} {period/2} {period})
    """
#======================================================
